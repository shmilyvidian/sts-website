...
const Courses = () => {
  const [selectedButton, setSelectedButton] = useState<
    'mobiledevelopment' | 'webdevelopment' | 'datascience' | 'cloudcomputing' | 'all' | null
  >('webdevelopment');
      ...
      >
        ...
        <div className="flex nowhitespace space-x-5 rounded-xl bg-white p-1 overflow-x-auto">
          ...
          <GlobeAltIcon
            ...
            height={70}
            className={`bg-white ${
              selectedButton === 'webdevelopment' ? 'border-b-2 border-orange fill-orange' : ''
          ...
          <DevicePhoneMobileIcon
            ...
            height={70}
            className={`bg-white ${
              selectedButton === 'mobiledevelopment' ? 'border-b-2 border-orange fill-orange' : ''
            } pb-2 block sm:hidden`}
          />
          <CircleStackIcon
            onClick={() => setSelectedButton('datascience')}
            ...
            height={70}
            className={`bg-white ${
              selectedButton === 'datascience' ? 'border-b-2 border-orange fill-orange' : ''
            } pb-2 block sm:hidden`}
          />
          <CloudIcon
            onClick={() => setSelectedButton('cloudcomputing')}
            ...
            height={70}
            className={`bg-white ${
              selectedButton === 'cloudcomputing' ? 'border-b-2 border-orange fill-orange' : ''
            } pb-2 block sm:hidden`}
          />
        </div>
